...
PaintingMesh::PaintingMesh(QWidget *parent) :
    QGLWidget(parent)
{
    modeColors = true;
    modeDisplay = 0;
...
void PaintingMesh::initialize(ConfigParams* cp) {
    this->param = cp;
}
void PaintingMesh::makeObject()
{
...
void PaintingMesh::initializeGL()
{
    makeObject();
...
void PaintingMesh::resizeGL(int width, int height)
{
...
void PaintingMesh::mousePressEvent(QMouseEvent *event)
{
    lastPos = event->pos();
}
void PaintingMesh::mouseMoveEvent(QMouseEvent *event)
{
...
void PaintingMesh::wheelEvent(QWheelEvent *event)
{
    int dx = event->delta();
...
void PaintingMesh::mouseReleaseEvent(QMouseEvent * /* event */)
{
    emit clicked();
}
/*////////////////////////////////////////////////////////////////////////*/
//  Ce que j'ai ajouté
/*////////////////////////////////////////////////////////////////////////*/
void PaintingMesh::keyPressEvent(QKeyEvent* event)
{
...
void PaintingMesh::rotateObjectBy(int xAngle, int yAngle, int zAngle)
{
...
void PaintingMesh::setClearColor(const QColor &color)
{
    clearColor = color;
    updateGL();
}
void PaintingMesh::displayGrid(void)
{
...
void PaintingMesh::displayLines(void)
{
    qglClearColor(clearColor);
...
void PaintingMesh::displayTriangles()
{
    qglClearColor(clearColor);
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
    glLoadIdentity();
...
void PaintingMesh::displayPoints()
{
    qglClearColor(clearColor);
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
    glLoadIdentity();
...
//displays the scene.
void PaintingMesh::displayCube(void)
{
    qglClearColor(clearColor);
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
    glLoadIdentity();
...
//draws a plane "net"
void PaintingMesh::drawNet(GLfloat size, GLint LinesX, GLint LinesZ)
{
    glBegin(GL_LINES);
...
void PaintingMesh::drawLines(QPainter *qp)
{
