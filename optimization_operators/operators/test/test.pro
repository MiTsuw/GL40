...
#static
        ...
        TARGET = ../../operators/bin/application
}
win32 {
        TARGET = ../../operators/bin/application
}
...
#  QMAKE_LIBDIR += $$CUDA_DIR/lib/x64
  ...
  INCLUDEPATH  += D:\creput\AUT14\gpu_work\popip\optimization_operators\operators\include ../include
  INCLUDEPATH  += D:\creput\AUT14\gpu_work\popip\basic_components\components\include
